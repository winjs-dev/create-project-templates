...
# eg：
npm run build:see - 构建结果是 xxxx-company-web-V202101-00-000-20211201092557.ea48d3ef.zip
npm run build:see prod - 构建结果是xxxx-company-web-V202101-00-000.zip
...
# eg
npm run build:see -dockerSeePack=true - 构建结果是 xxxx-company-web-docker-V202101-00-000-20211201092557.ea48d3ef.zip

npm run build:see prod -dockerSeePack=true - 构建结果是 xxxx-company-web-docker-V202101-00-000.zip
