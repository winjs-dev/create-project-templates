...
// 举个例子如下：
// 测试包：主要是提供给测试人员用的，包名是构建带时间串和gitcommitid的。如 xxxx-company-web-docker-V202101-00-000-20211201092557.ea48d3ef.zip
// 生产包：主要是用于生产环境部署的，包名不带时间串和gitcommitid的。如 xxxx-company-web-docker-V202101-00-000.zip
