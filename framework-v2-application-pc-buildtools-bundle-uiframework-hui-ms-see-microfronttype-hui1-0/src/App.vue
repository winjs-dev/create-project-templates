<template>
  <div id="frameworkV2ApplicationPcBuildtoolsBundleUiframeworkHuiMsSeeMicrofronttypeHui1041jp0hedm8s" class="framework-v2-application-pc-buildtools-bundle-uiframework-hui-ms-see-microfronttype-hui1-0-container">
