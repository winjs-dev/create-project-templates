...
// mini
const flagMiniCombinations = [
  ['framework=mini'],
  ['framework=mini', 'miniFramework=hola'],
  ['framework=mini', 'miniFramework=hola']
];

// v3
const flagV3Combinations = [
  ['framework=v3', 'application=mobile', 'buildTools=bundle', 'uiFramework=wui'],
  ['framework=v3', 'application=offline', 'buildTools=vite', 'uiFramework=vant'],
  ['framework=v3', 'application=pc', 'buildTools=bundle', 'uiFramework=element-ui']
];
